...
export default function Edit({korlap} : {korlap: {
    id : number, 
    nama : string, 
    alamat : string, 
    no_hp : string
    ...
    const handlerSimpan = (e: React.FormEvent) => {
        e.preventDefault();
        put(route('kormas.update',korlap.id), {
            onFinish: () => reset(),
        });
    }
    return (
        <Template title="Edit Kormas">
            <div className="container mx-auto p-3">
                <Link href="/kormas" className="inline-flex items-center p-2 mb-4 text-sm font-medium text-white bg-gray-800 rounded-full hover:bg-gray-700">
